...
#ifndef PB_KEYPAD_MESSAGES_PB_H_INCLUDED
#define PB_KEYPAD_MESSAGES_PB_H_INCLUDED
#include <pb.h>
...
#define MultipartMessage_init_default            {false, KeypadConfig_init_default, false, MultipartMessageConfig_init_default}
...
#define MultipartMessage_init_zero               {false, KeypadConfig_init_zero, false, MultipartMessageConfig_init_zero}
...
#define KeypadState_buttonRegister_tag           1
...
extern const pb_field_t MultipartMessage_fields[3];
...
#define MultipartMessage_size                    (30 + KeypadConfig_size)

/* Message IDs (where set with "msgid" option) */
#ifdef PB_MSGID

#define KEYPAD_MESSAGES_MESSAGES \
